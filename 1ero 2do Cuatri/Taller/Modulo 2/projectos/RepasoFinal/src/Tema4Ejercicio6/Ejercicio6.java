...
public class Ejercicio6 {
    public static void main(String[] args){
        ...
        Estacion estacion1 = new Estacion("La Plata",-32.291,-57.955);           //primer sistema
        SistemaPromedioAños años1 = new SistemaPromedioAños(5,2000,estacion1);
        
        años1.registrarTemperatura(11,2003 ,50.0);
        System.out.println("informacion obtenida del mes 11 del año 2003");
        System.out.println(años1.obtenerTemperatura(11, 2003));
        System.out.println(años1.informacion());
        ...
        Estacion estacion2 = new Estacion("Mar del Plata",-38.002,-57.556);      //segundo sistema
        SistemaPromedioMeses meses1 = new SistemaPromedioMeses(4,2020,estacion2);
        
        System.out.println(meses1.informacion());
    }
}
